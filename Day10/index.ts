...
addEmp({ id: 10, name: "Varshini", role: Role.User });
addEmp({ id: "xyz", name: "Satya", role: Role.User });
addEmp({ id: 20, name: "Keerthi", role: Role.Admin, priviledges: [Priviledge.Read, Priviledge.Write] });
getEmp(0);
getEmp(1);
getEmp(2);
