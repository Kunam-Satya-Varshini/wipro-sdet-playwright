...
// destructuring
// const arr = ["Satya", "Varshini", "Jaya", "Keerthi"];
// const first = arr[0];
// const second = arr[1];
// const third = arr[2];
// const fourth = arr[3];

const [first, second, third, fourth, fifth] = ["Satya", "Varshini", "Jaya", "Keerthi"]; // pos-based extraction
const [one, two, ...three] = [1, 3, 5, 6, 7];
console.log(first, second, third, fourth, fifth);
console.log(one, two, three)

const { name, age } = {name: "Satya", age: 23}; // key-based extracted
